...
{\centering \includegraphics[width=\linewidth]{figure/unnamed-chunk-2-1} 
...
The values for each item above represent the class average from $N = 15$ sections. The average of each item across all sections is 2.7.
...
{\centering \includegraphics[width=\linewidth]{figure/unnamed-chunk-3-1} 
